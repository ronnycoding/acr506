...
function Layout(props) {
  ...
  const { title, mainNavigation, footerNavigation, footerText, logo, url, socialNetworks } = config;
  ...
  return (
    <>
      ...
      <div className="container">
        ...
        <Footer navItems={footerNavigation} text={footerText} socialNetworks={socialNetworks} />
